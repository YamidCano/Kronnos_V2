    ...
    <main>
        ...
        <section class="slider-area pos-relative">
            <div class="slider-active">
                <div class="single-slider slide-1-style slide-height d-flex align-items-center" data-background="{{ asset('vue') }}/img/9.jpg">
                    <div class="shape-title bounce-animate">

                    </div>
                    <div class="shape-icon bounce-animate">
                    e    <img src="{{ asset('vue') }}/img/3.jpg" alt="">
                    </div>
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xl-5">
                                <div class="slide-shape1" data-animation="bounceInRight" data-delay=".9s"><img src="{{ asset('vue') }}/img/1.png" alt=""></div>
                                <div class="slide-shape2" data-animation="bounceInRight" data-delay="1.2s"><img src="{{ asset('vue') }}/img/2.png" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="single-slider slide-1-style slide-height d-flex align-items-center" data-background="{{ asset('vue') }}/img/3.jpg">
                    <div class="shape-title bounce-animate">

                    </div>
                    <div class="shape-icon bounce-animate">
                        <img src="{{ asset('vue') }}/img/1.png" alt="">
                    </div>
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-7">
                            ...
                            <div class="col-xl-5">
                                <div class="slide-shape1" data-animation="bounceInRight" data-delay=".9s"><img src="{{ asset('vue') }}/img/1.jpg" alt=""></div>
                                <div class="slide-shape2" data-animation="bounceInRight" data-delay="1.1s"><img src="{{ asset('vue') }}/img/4.png" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="banner mb-30">
                            <a href="shop.html"><img src="{{ asset('vue') }}/img/1.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="banner mb-30">
                            <a href="shop.html"><img src="{{ asset('vue') }}/img/2.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="banner mb-30">
                            <a href="shop.html"><img src="{{ asset('vue') }}/img/4_tamaño_modificado.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="product-slider owl-carousel">
                                        <div class="pro-item">
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/4.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/2.jpg" alt="">
                                                    </a>
                                            ...
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/2.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/4.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                        ...
                                        <div class="pro-item">
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/3.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/1.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                        ...
                                        <div class="pro-item">
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}img/1.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}img/1.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                        ...
                                        <div class="pro-item">
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/2.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/3.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                    ...
                                    <div class="product-slider owl-carousel">
                                        ...
                                        <div class="pro-item">
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}img/5.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/6.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                            ...
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/2.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/5.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                        ...
                                        <div class="pro-item">
                                            ...
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/4.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/8.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                        ...
                                        <div class="pro-item">
                                            ...
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/7.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/4.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                        ...
                                        <div class="pro-item">
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/8.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/7.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                    ...
                                    <div class="product-slider owl-carousel">
                                        <div class="pro-item">
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/10.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/8.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                        ...
                                        <div class="pro-item">
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        <img src="{{ asset('vue') }}/img/9.jpg" alt="">
                                                        <img class="secondary-img" src="{{ asset('vue') }}/img/9.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                            ...
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        ...
                                                        <img class="secondary-img" src="img/2.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                            ...
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        ...
                                                        <img class="secondary-img" src="img/4.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                            ...
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        ...
                                                        <img class="secondary-img" src="img/6.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                            ...
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        ...
                                                        <img class="secondary-img" src="img/8.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                                            ...
                                            <div class="product-wrapper mb-50">
                                                <div class="product-img mb-25">
                                                    <a href="product-details.html">
                                                        ...
                                                        <img class="secondary-img" src="img/1.jpg" alt="">
                                                    </a>
                                                    <div class="product-action text-center">
                                                        <a href="#" title="Shoppingb Cart">
                                                            <i class="flaticon-shopping-cart"></i>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="latest-news mb-40">
                            <div class="news__thumb mb-25">
                                <img src="{{ asset('vue') }}/img/6.jpg" alt="">
                            </div>
                        ...
                        <div class="col-xl-5">
                            <div class="subscribe d-flex fix">
                                <div class="subscribe-icon">
                                    <img src="{{ asset('vue') }}/img/9.png" alt="">
                                </div>
